...
##
## Debug
ProjectName            :=sys_tick
ConfigurationName      :=Debug
WorkspacePath          :=C:/Users/Andre/Desktop/DAT390_labb_v4
ProjectPath            :=C:/Users/Andre/Desktop/DAT390_labb_v4/sys_tick
...
PostBuild:
	...
	arm-none-eabi-objcopy -S -O srec  ./Debug/sys_tick.elf ./Debug/sys_tick.s19
	arm-none-eabi-objdump -D -S ./Debug/sys_tick.elf > ./Debug/sys_tick.dass
	@echo Done
...
$(IntermediateDirectory)/startup.c$(ObjectSuffix): startup.c $(IntermediateDirectory)/startup.c$(DependSuffix)
	$(CC) $(SourceSwitch) "C:/Users/Andre/Desktop/DAT390_labb_v4/sys_tick/startup.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/startup.c$(ObjectSuffix) $(IncludePath)
