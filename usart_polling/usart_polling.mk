...
##
## Debug
ProjectName            :=usart_polling
ConfigurationName      :=Debug
WorkspacePath          :=C:/Users/Andre/Desktop/DAT390_labb_v4
ProjectPath            :=C:/Users/Andre/Desktop/DAT390_labb_v4/usart_polling
...
ObjectsFileList        :="usart_polling.txt"
PCHCompileFlags        :=
...
PostBuild:
	...
	arm-none-eabi-objcopy -S -O srec  ./Debug/usart_polling.elf ./Debug/usart_polling.s19
	arm-none-eabi-objdump -D -S ./Debug/usart_polling.elf > ./Debug/usart_polling.dass
	@echo Done
...
$(IntermediateDirectory)/startup.c$(ObjectSuffix): startup.c $(IntermediateDirectory)/startup.c$(DependSuffix)
	$(CC) $(SourceSwitch) "C:/Users/Andre/Desktop/DAT390_labb_v4/usart_polling/startup.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/startup.c$(ObjectSuffix) $(IncludePath)
