...
ProjectPath            :=C:/Users/Andre/Desktop/DAT390_labb_v4/delay
...
PostBuild:
	...
	arm-none-eabi-objcopy -S -O srec  ./Debug/labb2_2.elf ./Debug/labb2_2.s19
	arm-none-eabi-objdump -D -S ./Debug/labb2_2.elf > ./Debug/labb2_2.dass
	@echo Done
...
$(IntermediateDirectory)/startup.c$(ObjectSuffix): startup.c $(IntermediateDirectory)/startup.c$(DependSuffix)
	$(CC) $(SourceSwitch) "C:/Users/Andre/Desktop/DAT390_labb_v4/delay/startup.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/startup.c$(ObjectSuffix) $(IncludePath)
