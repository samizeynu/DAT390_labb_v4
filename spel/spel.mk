...
Objects0=$(IntermediateDirectory)/structs.c$(ObjectSuffix) $(IntermediateDirectory)/delays.c$(ObjectSuffix) $(IntermediateDirectory)/main.c$(ObjectSuffix) $(IntermediateDirectory)/graphics.c$(ObjectSuffix) 
...
PostBuild:
	...
	arm-none-eabi-objcopy -S -O srec  ./Debug/spel.elf ./Debug/spel.s19
	arm-none-eabi-objdump -D -S ./Debug/spel.elf > ./Debug/spel.dass
	@echo Done
